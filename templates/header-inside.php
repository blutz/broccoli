	...
	<div class="container header">
		<div class="row inside" id="header-top">
			...
			<div class="dropdown visible-phone" id="dropdown-nav">
				...
				<ul class="dropdown-menu" id="mobile-dropdown">
					<a href="#"><li>About the CPO</li></a>
					<a href="#"><li>Contact us</li></a>
					<a href="#"><li>FAQ</li></a>
					<a href="#" id="header-nav-featured"><li>Apply to be an intern</li></a>
				</ul>
		...
		<div class="row" id="header-menu">
			<div class="hidden-phone">
				<ul id="header-inside-nav-links" class="span12">
					<a href="#"><li>About the CPO</li></a>
					<a href="#"><li>Contact us</li></a>
					<a href="#"><li>FAQ</li></a>
					<a href="#" id="header-nav-featured"><li>Apply to be an intern</li></a>
